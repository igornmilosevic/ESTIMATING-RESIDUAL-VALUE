...
# train.to_csv("RF_LGB_general_model_dataset_" + str(ModeID) + "_.csv", index=False)
...
for ind_val in ind_vals:
    for machine_val in machine_vals:
        ...
        df.to_csv("store_feat_importance.csv")
        ...
        valid_copy.to_csv("Validation_set_4_predictions_lgb_PG_" + str(ind_val) + "_" + str(machine_val) + "_.csv", index=False)
